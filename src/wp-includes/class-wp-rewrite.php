...
class WP_Rewrite {
	...
	public function generate_rewrite_rules( $permalink_structure, $ep_mask = EP_NONE, $paged = true, $feed = true, $forcomments = false, $walk_dirs = true, $endpoints = true ) {
		...
		/*
		 * Read the front page ID once. The loop below consulted it up to three times per
		 * directory, and each call runs the option filters even when alloptions is warm.
		 * It cannot change while the rules for one permastruct are being generated.
		 */
